...
are creating is a var field.  The base node knows how to export fields
to XML, but if the node contains some more complex data structures,
that nodetype needs to export that data structure itself.  In this
