...
#
#	Purpose
#		This creates the base FormObject class object that all FormObject
#		classes use.  There should never be any need for any derived
#		classes of FormObject to override this.
#
#	Returns
#		The blessed FormObject class
#
sub new
{
	my $class = shift @_;
	...
	# default to an order of 50.  Other form objects can change this
	# in their genObject() method.
